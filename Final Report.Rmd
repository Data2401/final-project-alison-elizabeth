...
---
In our initial discussion over choosing a topic for our project, we narrowed it down to environmental-related data because we were interested in seeing possible trends over time and the vast quantity of environmental data is available.
...
* __indoor_deaths__: Indoor air pollution is considered pollution that occurs in the household. Cooking with solid fuels:
  ...
  + Crop waste, dung
  + Charcoal, coal
  This method of cooking is commonly seen in underdeveloped countries.
* __outdoor_deaths__: Outdoor air or ambient air are emissions caused by combustion processes from motor vehicles, solid-fuel burning and industries
  + Ozone (O3)
...
#High Population Deaths 2001
p_high_first <- all_high_first %>%
  group_by(country) %>% 
  ggplot(aes(x= country, y= High_Deaths_01, fill = country)) +
  scale_color_gradient2(low = "light pink", mid = "pink", high = "dark violet", aesthetics = "color") +
  geom_col(position = 'dodge')

interact_high_first<- p_high_first + labs(title="High Populated Countries", x="2001 Deaths")

ggplotly(interact_high_first)

#High Population Deaths 2006
p_high_first <- all_high_first %>%
  group_by(country) %>% 
  ggplot(aes(x= country, y= High_Deaths_06, fill = country)) +
  scale_color_gradient2(low = "light pink", mid = "pink", high = "dark violet", aesthetics = "color") +
  geom_col(position = 'dodge')

interact_high_first<- p_high_first + labs(title="High Populated Countries", x="2006 Deaths")
...
interact_low_first<- p_low_first + labs(title="High Populated Countries", x="1996 Deaths")
...
interact_high_second<- p_high_second + labs(title="High Populated Countries", x="2007 Deaths", y="2017 Deaths")

ggplotly(interact_high_second)

#High Population Deaths 2007
p_high_second_07 <- all_high_second %>%
  group_by(country) %>% 
  ggplot(aes(x= country, y= High_Deaths_07, fill=country)) +
  scale_color_gradient2(low = "light pink", mid = "pink", high = "dark violet", aesthetics = "color") +
  geom_col(position = 'dodge')

interact_high_second_07<- p_high_second_07 + labs(title="High Populated Countries", x="2007 Deaths")

ggplotly(interact_high_second_07)

#High Population Deaths 2012
p_high_second_12 <- all_high_second %>%
  group_by(country) %>% 
  ggplot(aes(x= country, y= High_Deaths_12, fill=country)) +
  scale_color_gradient2(low = "light pink", mid = "pink", high = "dark violet", aesthetics = "color") +
  geom_col(position = 'dodge')

interact_high_second_12<- p_high_second_12 + labs(title="High Populated Countries", x="2012 Deaths")

ggplotly(interact_high_second_12)

#High Population Deaths 2017
p_high_second_17 <- all_high_second %>%
  group_by(country) %>% 
  ggplot(aes(x= country, y= High_Deaths_17, fill=country)) +
  scale_color_gradient2(low = "light pink", mid = "pink", high = "dark violet", aesthetics = "color") +
  geom_col(position = 'dodge')

interact_high_second_17<- p_high_second_17 + labs(title="High Populated Countries", x="2017 Deaths")

ggplotly(interact_high_second_17)
...
interact_low_second<- p_low_second + labs(title="Low Populated Countries", x="2007 Deaths", y="2017 Deaths")
...
interact_low_second_07<- p_low_second_07 + labs(title="Low Populated Countries", x="2007 Deaths")
...
interact_low_second_12<- p_low_second_12 + labs(title="Low Populated Countries", x="2012 Deaths")
...
interact_low_second_17<- p_low_second_17 + labs(title="Low Populated Countries", x="2017 Deaths")
