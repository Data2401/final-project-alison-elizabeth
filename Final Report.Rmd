---
title: "Final Report: Air Pollution Deaths"
...
* After selecting our deaths data frame due to air pollution we were able to compile a list of questions to explore
  
* Topics of Interest
  + How different air pollution types affect the population 
...
interact_high_first<- p_high_first + labs(title="High Populated Countries")
...
interact_high_second_07<- p_high_second_07 + labs(title="High Populated Countries")
...
interact_high_second_12<- p_high_second_12 + labs(title="High Populated Countries")
...
interact_high_second_17<- p_high_second_17 + labs(title="High Populated Countries")
...
* Which is worse - outdoor or indoor pollution?
  ...
  + "According to the EPA (Environmental Protection Agency), however, the levels of indoor air pollutants are often 2 to 5 times higher than outdoor levels, and in some cases these levels can exceed 100 times that of outdoor levels of the same pollutants. In other words, sometimes the air inside can be more harmful than the air outside."
