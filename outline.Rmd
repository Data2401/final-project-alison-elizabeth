...
ggplot(high_pop_countries, aes(x=Country.Name, y=Count, color=Country.Name))+
  geom_boxplot()+
...
ggplot(low_pop_countries, aes(x=Country.Name, y=Count, color=Country.Name))+
  geom_boxplot()+
...
ggplot(data=joined_high, aes(x=year, y=Count, color=country, size = total_deaths/Count)) +
  geom_line() +
  labs(title="Percentage of Death Count High Population", subtitle="Bar width is equal to percentage of Deaths")+
  xlab("Year")+
  ylab("Population")

ggplot(data=joined_low, aes(x=year, y=Count, color=country, size = total_deaths/Count)) +
  geom_line() +
  labs(title="Percentage of Death Count Low Population", subtitle="Bar width is equal to percentage of Deaths")+
  xlab("Year")+
  ylab("Population")
```
...
h<- ggplot(deaths_highpop_countries)+
  geom_col(mapping = aes(x=country, y=average_death_high, color=country))+
             xlab("Country")+
...
l <- ggplot(deaths_lowpop_countries)+
  geom_col(mapping = aes(x=country, y=average_death_low, color=country))+
             xlab("Country")+
             ylab("Average deaths (per 100,000)")+
...
l_outdoor <- ggplot(low_poll, aes(x=country, y = avg_outdoor, color = avg_ozone)) +
  geom_point() +
  labs(title = "Average Death due to Outdoor Air Pollution for Low Population")
ggplotly(l_outdoor)
```
...
indoor_high<- deaths_df %>% 
  ...
  ggtitle("High Populated Indoor Death 1996-2017")+
  xlab("Year")+
...
indoor_low<- deaths_df %>% 
  ...
  ggplot()+
  geom_point(aes(year, indoor_deaths, color = country))+
  ggtitle("Low Populated Indoor Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
ggplotly(indoor_low)
...
indoor_top<- deaths_df %>% 
  ...
  ggplot()+
  geom_point(aes(year, indoor_deaths, color = country))+
  ggtitle("Greatest Indoor Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
ggplotly(indoor_top)
```
...
outdoor_high<- deaths_df %>% 
  ...
  ggtitle("High Populated Outdoor Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
...
outdoor_low<- deaths_df %>% 
  ...
  ggplot()+
  geom_point(aes(year, outdoor_deaths, color = country))+
  ggtitle("Low Populated Outdoor Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
...
outdoor_top<- deaths_df %>% 
  ...
  ggplot()+
  geom_point(aes(year, outdoor_deaths, color = country))+
  ggtitle("Greatest Outdoor Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
...
ozone_high<- deaths_df %>% 
  ...
  ggtitle("High Populated Ozone Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
ggplotly(ozone_high)
...
ozone_low<- deaths_df %>% 
  ...
  ggplot()+
  geom_point(aes(year, ozone_deaths, color = country))+
  ggtitle("Low Populated Ozone Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
ggplotly(ozone_low)
...
ozone_top<- deaths_df %>% 
  ...
  ggplot()+
  geom_point(aes(year, ozone_deaths, color = country))+
  ggtitle("Greatest Ozone Death 1996-2017")+
  xlab("Year")+
  ylab("Deaths per 100,000")
ggplotly(ozone_top)
```
