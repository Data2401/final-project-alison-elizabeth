---
title: "Global deaths due to air ollution"
...
Import the Deaths by Air Pollution data
```{r}
...
Let's split the data into high and low population based on country
...
- full join deaths_df and world_pop2
